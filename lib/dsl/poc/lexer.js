...
const namePattern = /[a-zA-Z][a-zA-Z_\-\d.]*/;
...
// The restrictions on the names should be implemented as semantic checks
...
createToken({
  ...
  // These tokens, In practical terms this means the parser
  // Does not need to have hundreds of "SPACE*" everywhere (unlike pegjs).
...
createToken({ name: 'APPLICATION_PATH', pattern: 'path' });
