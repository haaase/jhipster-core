...
const COMMON_DB_VALIDATIONS = {
  String: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED, VALIDATIONS.MINLENGTH, VALIDATIONS.MAXLENGTH, VALIDATIONS.PATTERN]),
  Integer: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Long: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  BigDecimal: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Float: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Double: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Enum: new Set([VALIDATIONS.REQUIRED]),
  Boolean: new Set([VALIDATIONS.REQUIRED]),
  LocalDate: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED]),
  ZonedDateTime: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED]),
...
const CASSANDRA_VALIDATIONS = {
  ...
  Double: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Boolean: new Set([VALIDATIONS.REQUIRED]),
  Date: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED]),
  UUID: new Set([VALIDATIONS.PRIMARY_KEY, VALIDATIONS.REQUIRED]),
  Instant: new Set([VALIDATIONS.REQUIRED])
};
